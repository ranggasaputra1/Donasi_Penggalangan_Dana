...
class KuisionerController extends Controller
{
    ...
    // Menampilkan halaman form kuisioner
    ...
    // Menangani pengiriman form kuisioner
    public function submit(Request $request)
    {
        // Validasi input berdasarkan form kuisioner
        $data = $request->validate([
            ...
            // Rekening angka minimal 6 digit
        ...
        // Menyimpan data kuisioner ke dalam tabel
