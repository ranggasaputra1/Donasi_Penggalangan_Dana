...
<style>
    /* Styling agar submenu tetap terbuka jika parent memiliki class 'active' */
    .sidebar-item.has-sub.active>.submenu {
        display: block !important;
    }

    /* Ini mungkin sudah ada di kode Anda, ini untuk menyembunyikan submenu secara default */
    .submenu {
        display: none;
    }
</style>
